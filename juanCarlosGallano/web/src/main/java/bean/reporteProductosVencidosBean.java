...
@ManagedBean (name = "reporteProductosVencidosBean")
@ViewScoped
public class reporteProductosVencidosBean {
...
public void exportarProductoVencidosPDF() throws IOException{
		...
		String nombreReporte = "/reportes/ProductosVencidos.jrxml";
